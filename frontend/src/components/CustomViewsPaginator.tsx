...
const CustomViewsPaginator: React.FC<CustomViewsPaginatorProps> =  ({totalElements, currentIndex, onChange}) => {
    ...
    const handleDocChange = (e: any) => {
        if (e.target.value && e.target.value !== undefined && e.target.value < totalElements) {
