...
def test_delete_project_success(mock_get_assets, mock_get_project, mock_db):
...
@patch("app.repositories.project_repository.get_project")
def test_delete_project_not_found(mock_get_project, mock_db):
...
@patch("app.repositories.project_repository.get_project")
@patch("app.repositories.project_repository.get_assets")
def test_delete_project_db_error(mock_get_assets, mock_get_project, mock_db):
